...
| kubernetes-version                        | 指定 kubernetes 固定版本：包含：主版本号、次版本号、修正版本号，如：v1.30.0，请与 `kubernetes-repo-new-version` 保持在同一个 主版本包 和 次版本号 下                                                                         | 最新版                                                                                                                                            | kubernetes-version=v1.30.0                                                                                                                                            |
| kubernetes-repo-new-version               | 指定 kubernetes 新版仓库版本，仅包含：主版本号、次版本号，例如：v1.24、v1.25、v1.26、v1.27、v1.28、v1.29、v1.30，默认值：v1.30                                                                                     |                                                                                                                                                | kubernetes-repo-new-version=v1.30                                                                                                                                     |
...
| calico-version                            | 指定 calico 版本                                                                                                                                                                  | v3.27.3                                                                                                                                        | calico-version=v3.27.3                                                                                                                                                |
...
| metrics-server-version                    | 指定 Metrics Server 版本                                                                                                                                                          | v0.6.3                                                                                                                                         | metrics-server-version=v0.7.1                                                                                                                                         |
