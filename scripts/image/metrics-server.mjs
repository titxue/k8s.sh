...
async function tags(page, per_page) {
  ...
  const ref = 'registry.k8s.io/metrics-server/metrics-server/v0.4.0'
  // https://gitlab.xuxiaowei.com.cn/hub.docker.com/github.com/kubernetes-sigs/metrics-server 项目 ID: 248
  const gitlabRepositoryBranchesUrl = `https://gitlab.xuxiaowei.com.cn/api/v4/projects/248/repository/branches?ref=${ref}&branch=`
